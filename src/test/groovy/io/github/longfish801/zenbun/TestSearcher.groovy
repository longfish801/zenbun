...
public class TestSearcher extends TestCase {
	/** ファイル入出力のテスト用フォルダ */
	static final File testDir = PackageDirectory.deepDir('src/test/resources', TestSearcher.class);
	/** ログ出力インスタンス */
	static final Logger LOG = LoggerFactory.getLogger(TestSearcher.class);
